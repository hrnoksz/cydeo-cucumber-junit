...
public class Order_StepDefinitions {
    ...
    public void user_enters_quantity(int quantity) {
        ...
        //We need to delete current quantity in the box before sending new quantity
        //clear() method will delete whatever is in the input box
        orderPage.inputQuantity.clear();

        //Or we can use sendKeys() method for clearing box
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
         ...
         */
        //We created clickRadioButton() method inside BrowserUtils class
